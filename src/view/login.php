...
<body>
    <main class=" h-screen flex justify-center items-center bg-[#fff5d2]">
        <div class=" flex flex-col items-center ">
            ...
            <form  class=" w-[350px] h-[250px]  flex flex-col gap-6 justify-center items-center rounded-2xl bg-slate-200 " action="/src/handle_db/user_db.php" method="post">
                <p>Bienvenido Ingresa con tu cuenta</p>
                
                    <div class="flex">
                        <img class=" w-7 h-7" src="/public/email.png" alt="email">
                        <input class="  ml-6  rounded-md w-56 h-8 " type="email" placeholder="email" name="email">
                    </div>
                    <div class="flex  ">
                        <img class=" w-7 h-7 " src="/public/pass.png" alt="password">
                        <input class="ml-6 rounded-md w-56 h-8 relative " type="password" placeholder="password" name="password">
                    </div>
