...
<body>
    <div class="flex flex-col justify-center  h-screen items-center">
        ...
        <form class=" w-[350px] h-[600px]  flex flex-col gap-4 justify-center  rounded-2xl bg-slate-200 p-4" action="/src/handle_db/edit_db_alumno.php" method="post">
            <h1 class="text-[30px] font-semibold">Editar Alumno</h1>
            <input type="text" name="id" hidden value="<?= $data["id_user"] ?>">
            <label class=" font-semibold" for="dni">DNI </label>
            <input class="w-[310px] h-[30px] rounded-md" type="text" name="dni" value="<?= $data["dni"] ?>">
